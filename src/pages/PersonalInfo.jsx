...
const PersonalInfo = () => {
  ...
  const personalInfo = [
    // Your existing personalInfo array remains unchanged
    {
      ...
      details: (
        <div className="contact-details">
          ...
          <a href="https://linkedin.com/in/egemen-alkan" target="_blank" rel="noopener noreferrer" className="linkedin-link">
    ...
    {
      category: 'Interests',
      details: 'Formula 1, Football, Video Games, Basketball, Hiking, Biking',
      icon: (
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    },
    {
      ...
      details: 'Open to all work arrangements',
      icon: (
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          {personalInfo.map((info, index) => (
            <div key={index} className="info-card">
              ...
              <div className="info-content">
                <h3 className="info-category">{info.category}</h3>
                <div className="info-details">{info.details}</div>
              </div>
            </div>
          ))}
        </div>
