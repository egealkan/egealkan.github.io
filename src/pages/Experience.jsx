    ...
    },
    {
      ...
      steps: [
        ...
        },
        {
          ...
          description: 'The bench has a containerized REST API using FastAPI and Docker to manage conversation sessions, audio processing, and analytics logging for the frontend interface.'
        }
      ]
    },
    {
      ...
      steps: [
        ...
        {
          title: 'Credentials',
          description: 'Student: test1@example.com (pw: password), Coach: test@example.com (pw: password), Coordinator: test2@example.com (pw: password)',
        }
      ]
    },
  ];
