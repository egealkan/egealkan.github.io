...
const Internship = () => {
  const internshipData = {
    ...
    documents: [
      {
        name: "Internship Realisation Document",
        description: "Comprehensive 87-page report detailing the technical implementation, challenges, and AI benchmarking results.",
        available: true
      },
      {
        name: "Project Plan", 
        description: "Initial planning document outlining the business case, phases, and projected methodology.",
        available: true
      },
      {
        name: "Summary Document",
        description: "Executive summary of the project deliverables and business value generated.", 
        available: true
      },
      {
        name: "Reflection Document",
        description: "Personal reflection on professional growth, competencies acquired, and lessons learned.", 
        available: true
      }
    ]
  };
                ...
                {internshipData.documents.map((doc, index) => (
                  <div key={index} className="document-item">
                    ...
                    <div className="document-status">
                      {doc.available ? (
                        <a 
                          href={`/${doc.name}.pdf`} // Assuming files will be in public folder
