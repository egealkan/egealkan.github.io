  ...
  const skillsData = [
    {
      ...
      location: 'Geel, Belgium',
      skills: {
        'AI and data': ['AI', 'Deep Learning', 'NLP', 'Computer Vision', 'Machine Learning', 'Neural Networks', 'TensorFlow', 'PyTorch', 'Data Engineering', 'AWS', 'Microsoft Copilot Studio'],
        development: ['ASP.NET', 'React', 'SQL', 'PHP', 'C#', 'Python', 'JavaScript', 'Java'],
        business: ['Business Process', 'Business Intelligence (BI)', 'Qlik Sense', 'UML', 'Microsoft Power BI', 'Microsoft Power Automate', 'Microsoft PowerApps']
      }
    },
    {
      university: 'University of Victoria',
