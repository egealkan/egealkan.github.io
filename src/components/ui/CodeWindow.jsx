...
//           height: 400px; /* Fixed height to match Chat */
//           display: flex;
//           flex-direction: column;
//           width: 100%;
//           min-width: 0; /* CRITICAL FIX: Allows flex item to shrink on mobile */
...
//           min-width: 0; /* CRITICAL FIX: Prevents pre tag from expanding container */
//           width: 100%;
//         }
//         .code-area pre {
//           margin: 0;
